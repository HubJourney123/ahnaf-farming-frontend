...
const FloatingWhatsAppButton = () => {
  const whatsappLink = "https://wa.me/+8801753388992"; // Your WhatsApp number

  // Inject styles using useEffect to avoid hydration issues
  useEffect(() => {
    const styles = `
      ...
      /* Subtle firefly glow effect */
      @keyframes firefly-glow {
        0% {
          box-shadow: 0 0 5px rgba(37, 211, 102, 0.4), 0 0 10px rgba(37, 211, 102, 0.2);
        }
        50% {
          box-shadow: 0 0 10px rgba(37, 211, 102, 0.7), 0 0 20px rgba(37, 211, 102, 0.5), 0 0 30px rgba(37, 211, 102, 0.3);
        }
        100% {
          box-shadow: 0 0 5px rgba(37, 211, 102, 0.4), 0 0 10px rgba(37, 211, 102, 0.2);
        }
      ...
      .whatsapp-button {
        ...
        z-index: 50;
        animation: 
          gentle-float 3s infinite ease-in-out,
